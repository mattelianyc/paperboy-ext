...
function handleEvent(event) {
  ...
  movementTimeout = setTimeout(() => {
    if (mouseStartedMoving && mouseStoppedMoving) {
      ...
      actionDescription = `//mouse::[${endingCoordinates[0]},${endingCoordinates[1]}]\n`;
      console.log('act', actionDescription);
  ...
  }, 200); // 100ms without a new mousemove event is considered the end of the movement
